...
@router.post(path='/', summary='Criar uma nova Categoria', status_code=status.HTTP_201_CREATED, response_model=CategoriaOut,)
...
@router.get(path='/{id}', summary='Consulta uma categoria pelo id', status_code=status.HTTP_200_OK, response_model= CategoriaOut,)
